...
# This script takes the SD of each column read from stdin
# example usage: cut -d\  -f2,3 file.txt | min.R -h
#   take columns 2 and 3 from file file.txt and report the SD, ignore the header
...
print(apply(as.matrix(data),2,sd,na.rm=T))
